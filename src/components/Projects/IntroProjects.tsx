...
export const IntroProjects = ({ translations }: Props) => {
  return (
    <div className='flex flex-col items-center justify-center relative px-4 mx-auto w-full md:max-w-[769px] sm:max-w-[640px] lg:max-w-[1024px] xl:max-w-[1024px] 2xl:max-w-[1280px]'>
